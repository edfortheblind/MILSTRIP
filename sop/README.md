...
in the earlier [planning SOP](../docs/POWER_APPS_LAPTOP_DEV_SOP.md).

The conversation record is a sanitized substantive account, not a verbatim
chat export. Credentials, request authorization headers, raw gateway logs and
unnecessary personal or tenant identifiers are deliberately excluded.
